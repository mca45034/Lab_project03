...
background-image: linear-gradient(to bottom right, red, black, whites);
...
padding-bottom: 11px;
 ...
 .p4 {
	background-image: url('<%=ORSView.APP_CONTEXT%>/img/03.jpg.jpg');
	...
	<div>
		...
		<form action="<%=ORSView.USER_REGISTRATION_CTL%>" method="post">
			...
			<div class="row pt-3">
				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon  rahul">
						<div class="card-body">
							...
							<h3 class="text-center default-text text-primary pb-2">Patient
								Registration</h3>
							<!--Body-->
							<div>
		       ...
		       <!--  ----------------------------------------------------------------------------------------------------------	 -->
		       <span class="pl-sm-5"><b>Age</b> <span
								style="color: red;">*</span></span> </br>
							<div class="col-sm-12">
								<div class="input-group">
									<div class="input-group-prepend">
									...
									<input type="text" class="form-control" id="defaultForm-email"
										maxlength="10" name="age" placeholder="age"
										value="<%=DataUtility.getStringData(dto.getAge()).equals("0") ? ""
					                                                                          : DataUtility.getStringData(dto.getAge())%>">
								</div>
							</div>
		       ...
		       <!--  ----------------------------------------------------------------------------------------------------------	 -->	
							...
							<span class="pl-sm-5"><b>Date</b> <span style="color: red;">*</span></span></br>
							<div class="col-sm-12">
								<div class="input-group">
									<div class="input-group-prepend">
										<div class="input-group-text">
