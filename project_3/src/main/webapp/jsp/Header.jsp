...
<style type="text/css">
.rahul {
	background-image: linear-gradient(to bottom right, aqua, aqua, aqua);
}
</style>
</head>
<body>
	...
	<div class="header">
		<nav class="navbar navbar-expand-lg fixed-top  rahul"> <a
			...
			src="<%=ORSView.APP_CONTEXT%>/img/APEX-logo3-300x193.jpeg" width="190px"
			height="50px"></a>
  ...
  --%>
				...
				<li class="nav-item dropdown" style="padding-left: 5px;"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: Black;">Patient Details</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
				...
				<li class="nav-item dropdown"
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="<%=ORSView.LOGIN_CTL%>"><i
							...
							class="fas fa-registered"><b> Patient Registration</b></i></a>
					</div></li>
				<%
					}
				%>
